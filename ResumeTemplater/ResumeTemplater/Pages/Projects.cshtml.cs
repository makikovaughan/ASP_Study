        ...
        public void OnGet()
        {
            Projects = new List<Project> {
                new Project()
                {
                    ...
                    Year = 2019,
                    Technologies = new List<string>{"JavaScript", "SpringBoot", "Java", "MongoDB"}
                },
                new Project()
                {
                    ...
                    Year = 2019,
                    Technologies = new List<string>{"C#", "ASP.NET", "SQLite"}
                },
                new Project()
                {
                    Title = "Password Box",
                    ...
                    Year = 2020,
                    Technologies = new List<string>{"JavaScript", "SpringBoot", "HTML", "CSS"}
                },
                new Project(){
                    Title = "Spotivize",
                    ...
                    Year = 2016,
                    Technologies = new List<string>{"JavaScript", "SpringBoot", "MongoDB"}
                }
            };
